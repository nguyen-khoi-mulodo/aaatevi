...
@interface LikedChannelVC_iPad ()

@end

@implementation LikedChannelVC_iPad
...
- (UIGridViewCell *) gridView:(UIGridView *)grid cellForRowAt:(int)rowIndex AndColumnAt:(int)columnIndex andSection:(int) section
{
    ...
    static NSString *CellIdentifier1 = @"channelLikedItemCell";
    ...
    if (arr.count > index) {
        ChannelLikedItemCell *cell = (ChannelLikedItemCell *)[grid dequeueReusableCell:CellIdentifier1];
        if (cell == nil) {
