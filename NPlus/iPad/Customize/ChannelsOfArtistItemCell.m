...
@implementation ChannelsOfArtistItemCell
...
- (id)init {
    ...
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(0, 0, 208, 177);
        
        [[NSBundle mainBundle] loadNibNamed:@"ChannelsOfArtistItemCell" owner:self options:nil];
