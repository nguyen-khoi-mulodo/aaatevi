    ...
    if (self.type == HMSegmentedControlTypeText) {
        [self.sectionTitles enumerateObjectsUsingBlock:^(id titleString, NSUInteger idx, BOOL *stop) {
            ...
            if (self.segmentWidthStyle == HMSegmentedControlSegmentWidthStyleFixed) {
                ...
                rectDiv = CGRectMake((self.segmentWidth * idx)-0.5, 7, 1, self.frame.size.height - 14);
            ...
            if ([self isShowVerticalDivider] && idx>0) {
                ...
                borderBottom.frame = CGRectMake(0, self.frame.size.height - 1, self.scrollView.contentSize.width, 1);
                borderBottom.backgroundColor = RGB(206, 206, 206).CGColor;
                
                [self.scrollView.layer addSublayer:borderBottom];
            }
        }];
