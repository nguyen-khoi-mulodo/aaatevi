...
@interface CartoonVC ()<ListItemDelegate>
...
-(void)loadDataWithCurPage:(NSInteger)cPage withViewController:(ListItemVC *)controller{
    ...
    [[APIController sharedInstance] getShowByGenre:@"5192" withPage:[NSString stringWithFormat:@"%ld", (long)cPage] withSort:controller.isHot ? @"0" : @"1" completed:^(NSArray *results, BOOL isMore, NSString* genreID, NSString* strSort) {
...
-(void)loadGenreWithViewController:(ListItemVC *)viewController{
    [[APIController sharedInstance] getListSubGenre:@"5192" completed:^(NSArray *results) {
