...
@interface TVShowVC ()<ListItemDelegate>
...
-(void)loadDataWithCurPage:(NSInteger)cPage withViewController:(ListItemVC *)controller{
    ...
    [[APIController sharedInstance] getShowByGenre:@"5162" withPage:[NSString stringWithFormat:@"%ld", (long)cPage] withSort:controller.isHot ? @"0" : @"1" completed:^(NSArray *results, BOOL isMore, NSString* genreID, NSString* strSort) {
...
-(void)loadGenreWithViewController:(ListItemVC *)viewController{
    [[APIController sharedInstance] getListSubGenre:@"5162" completed:^(NSArray *results) {
