...
#define FWT_PBH_FILL_COLOR          [[UIColor blackColor] colorWithAlphaComponent:.8f].CGColor
#define FWT_PBH_STROKE_COLOR        [[UIColor blackColor] colorWithAlphaComponent:.9f].CGColor
#define FWT_PBH_LINE_WIDTH          .5f
